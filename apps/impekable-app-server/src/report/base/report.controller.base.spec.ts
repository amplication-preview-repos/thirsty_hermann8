...
const CREATE_INPUT = {
  ...
  resolutionComments: "exampleResolutionComments",
  ...
  test("POST /reports", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        reportDatetime: CREATE_RESULT.reportDatetime.toISOString(),
      ...
      .expect([
        {
          ...
          reportDatetime: FIND_MANY_RESULT[0].reportDatetime.toISOString(),
  ...
  test("GET /reports/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        reportDatetime: FIND_ONE_RESULT.reportDatetime.toISOString(),
