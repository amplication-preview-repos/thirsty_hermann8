...
export class RequestResolverBase {
  ...
  async getBooking(@graphql.Parent() parent: Request): Promise<Booking | null> {
  ...
  async getOffice(@graphql.Parent() parent: Request): Promise<Office | null> {
  ...
  async getReport(@graphql.Parent() parent: Request): Promise<Report | null> {
